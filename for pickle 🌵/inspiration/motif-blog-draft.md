...
As a teacher, I faced a similar struggle with collecting "practice minutes." I wanted students to structure their practice time, but not feeling like their whole practice session was spent writing or filling out a worksheet. Putting assignments on Google Classroom made it more distracting for kids if they had to switch between multiple tabs.
...
- Formatted notes section to remember all of the details from your practice session
