---
title: "The Journey of My First UX Project: Initial Research, Personas, and Competitive Audit"
...
The course has you use [Sharpen's Design Prompt Generator](https://sharpen.design/) to choose an application that you would like to build. I cycled through many prompts until I got to one that caught my eye: **Design a customer service application for an animal shelter in your favorite city**. I chose this prompt for a few reasons:

1. I love my rescue dog
2. It was not an app for a restaurant, coffeeshop, or beer garden
...
![A screenshot of the ChatGPT interview session](/images/blog/first-ux-project-research-personas-competitive-audit/image13.png)
...
![A screenshot of ChatGPT providing feedback on the interview technique](/images/blog/first-ux-project-research-personas-competitive-audit/image5.png)
...
![A screenshot of the improved fourth interview session](/images/blog/first-ux-project-research-personas-competitive-audit/image13-1.png)
...
![A screenshot of the interview notes table in Google Docs](/images/blog/first-ux-project-research-personas-competitive-audit/image8.png)
...
![A screenshot of the affinity diagram identifying common themes across interviews](/images/blog/first-ux-project-research-personas-competitive-audit/image1.png)
...
![Persona document for Heather](/images/blog/first-ux-project-research-personas-competitive-audit/image2-2.png)

![Persona document for Robert](/images/blog/first-ux-project-research-personas-competitive-audit/image10.png)

![User journey map for Heather](/images/blog/first-ux-project-research-personas-competitive-audit/image7.png)

![User journey map for Robert](/images/blog/first-ux-project-research-personas-competitive-audit/image16.png)
...
![A Freeform whiteboard screenshot showing all the feature ideas on sticky notes](/images/blog/first-ux-project-research-personas-competitive-audit/image9.png)
...
![Freeform whiteboard showing user problems mapped next to feature ideas](/images/blog/first-ux-project-research-personas-competitive-audit/image15.png)
...
![Freeform whiteboard showing features organized into the four value categories](/images/blog/first-ux-project-research-personas-competitive-audit/image14.png)
...
![Freeform whiteboard connecting specific features to each persona](/images/blog/first-ux-project-research-personas-competitive-audit/image19.png)
...
![The completed Freeform whiteboard session](/images/blog/first-ux-project-research-personas-competitive-audit/image4.png)
...
![A screenshot of the initial competitor research notes](/images/blog/first-ux-project-research-personas-competitive-audit/image17.png)
...
![Competitive audit sheet — page 1](/images/blog/first-ux-project-research-personas-competitive-audit/screenshot-2023-10-16-at-5.27.37-pm.png)

![Competitive audit sheet — page 2](/images/blog/first-ux-project-research-personas-competitive-audit/screenshot-2023-10-16-at-5.28.05-pm.png)

![Competitive audit sheet — page 3](/images/blog/first-ux-project-research-personas-competitive-audit/screenshot-2023-10-16-at-5.28.21-pm.png)

After extensive research, I summarized my findings in a competitive audit report. The full report can be found [here](https://docs.google.com/document/d/172ZuuK8fY_oUg6GUgHMaasBlahn1f1i6-bcFl4zMIpI/edit?usp=sharing). Through my research, I found three main gaps in the market:

1. **Post-Adoption Support:** None of the competitors seem to specifically focus on the post-adoption phase. New pet owners often face challenges after adopting a pet, from behavioral issues to understanding their new pet's unique needs.

2. **Collaborative Features:** While some apps like "Buddies" offer community boards and chats, there isn't a comprehensive feature allowing multiple family members or friends to collaborate on pet care.

3. **Custom Pet Wellness Plans:** While many of the apps offer plenty of resources related to training, first aid, or nutrition, none of the apps offer any plans tailored to your pet's specific needs.

I saw these gaps as opportunities to create three key features in my application:

1. An AI chatbot that references learning materials available in the app, vetted by professionals in the field.
2. A collaborative feature that allows multiple pet owners/family/household members to see specific tasks completed related to the pet (example: when the dog has been walked, fed, given medication, etc.)
3. An AI that helps create a custom plan related to pet training or diet
